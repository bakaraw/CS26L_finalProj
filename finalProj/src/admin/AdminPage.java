...
public class AdminPage extends DatabaseHandler{
	...
	void Initialization(){
		...
		frame.setBounds(100, 100, 1254, 711);
		...
		tabbedPane.setBounds(10, 11, 1208, 514);
		...
		scrollPane.setBounds(10, 88, 773, 382);
		
		JPanel removePn = new JPanel();
		removePn.setBounds(806, 88, 387, 382);
		...
		btnRemoveProd.setBounds(112, 343, 103, 23);
		...
		scrollPane_4.setBounds(112, 180, 250, 145);
		...
		stockbyField.setBounds(171, 135, 346, 28);
		...
		btnAddProd.setBounds(192, 374, 170, 37);
		...
		scrollPane_3.setBounds(170, 292, 346, 68);
		...
		btnAddStock.setBounds(224, 374, 170, 37);
		...
		scrollPane_2.setBounds(193, 263, 346, 99);
