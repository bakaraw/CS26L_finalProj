			...
			InventoryPanelLayout.createParallelGroup(Alignment.TRAILING)
				.addGroup(InventoryPanelLayout.createSequentialGroup()
					...
					.addGroup(InventoryPanelLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(Alignment.TRAILING, InventoryPanelLayout.createParallelGroup(Alignment.LEADING, false)
							.addGroup(InventoryPanelLayout.createParallelGroup(Alignment.BASELINE)
								...
								.addComponent(btn_StockIn, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE)
								.addComponent(btn_Remove, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE))
