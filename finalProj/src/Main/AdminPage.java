...
public class AdminPage extends DatabaseHandler {
	...
	void Initialization() {
		...
		gl_header.setHorizontalGroup(gl_header.createParallelGroup(Alignment.LEADING).addGroup(Alignment.TRAILING,
				gl_header.createSequentialGroup().addGap(62).addComponent(lblNewLabel_1)
		...
		gl_header.setVerticalGroup(gl_header.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_header
						.createSequentialGroup().addGap(61).addGroup(gl_header.createParallelGroup(Alignment.BASELINE)
		...
		btnDeleteLogs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(null,
						"Are you sure you want to delete all data in this table?", "Confirm Dialog",
